...
function ConfirmInfo({ formData, setFormData }) {
  ...
  const rows = [
    ...
    createData("Restaurant Banner Image", selectedFile == null ? 'No banner file selected' : selectedFile.name),
    createData("Restaurant Logo Image", selectedLogo == null ? 'No logo file selected' : selectedFile.name),
