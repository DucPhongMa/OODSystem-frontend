        ...
        <Grid container spacing={4} alignItems="center">
          ...
          <Grid item xs={12} md={6}>
            ...
            <Typography variant="body1" paragraph>
              Our mission is to empower restaurant owners with a digital
              presence that enhances their customer's experience, offering an
              intuitive and efficient online ordering system.
            </Typography>
          </Grid>
        </Grid>
          ...
          <Grid container spacing={2}>
            <Grid item xs={12} sm={4}>
              ...
              <Typography>
                ...
                all else, ensuring every interaction adds value.
              </Typography>
            </Grid>
            <Grid item xs={12} sm={4}>
              <Typography variant="h6" gutterBottom>
              ...
              <Typography>
                Continuously seeking out new ways to improve and evolve our
                platform to meet the changing needs of the industry.
              </Typography>
            </Grid>
            <Grid item xs={12} sm={4}>
              <Typography variant="h6" gutterBottom>
